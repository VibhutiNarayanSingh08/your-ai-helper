...
electron_1.contextBridge.exposeInMainWorld("electronAPI", {
    ...
    // Add getDesktopSources for system audio capture
    getDesktopSources: async (opts) => {
        // @ts-ignore: desktopCapturer is available in preload
        const sources = await electron_2.desktopCapturer.getSources(opts);
        // Only return id, name, and thumbnail (as dataURL)
